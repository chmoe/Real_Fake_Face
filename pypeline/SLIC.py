...
class SLIC(object):
    ...
    def run(self, list_name: str, real_or_fake: str):
        ...
        train_processed_list = Config.get_image_file_list(Config.path_exist(path_train), True)
        ...
        Debug.info("即将开始处理", self.K, "training_data, 从{}开始".format(start_train_count))
        ...
        # 验证集
        Debug.info("即将开始处理", self.K, "validation_data, 从{}开始".format(start_validation_count))
